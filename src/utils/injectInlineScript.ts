/**
 * Utility to inject the performance inline script into the HTML head
 * This ensures the performance optimizations run as early as possible
 */
...
export function injectPerformanceScript() {
  ...
  if (document.querySelector('#performance-inline-script')) return;

  const script = document.createElement('script');
  script.id = 'performance-inline-script';
  script.innerHTML = `
