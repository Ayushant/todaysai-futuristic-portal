...
const timelineItems: TimelineItem[] = [
  {
    ...
    description: 'Started as an AI research lab with our engineers'
  },
  {
    year: '2026',
    title: 'Intial First Product Launch.'
  ...
  {
    year: '2027',
    title: 'Planing Global Expansion',
    description: ''
  },
...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 relative overflow-hidden bg-navy-200/30">
      ...
      <div className="container px-4 mx-auto relative z-10">        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold heading-gradient mb-5">About atkind</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="glass-card p-8">
            <h3 className="text-2xl font-bold mb-4 text-white">Your AI Partner</h3>            <p className="text-white/80 mb-4">              Atkind was founded with a clear mission: to democratize advanced AI technologies and make them accessible
            ...
            <p className="text-white/80 mb-4">
              Our team of 10+ AI specialists, data scientists, and engineers work at the cutting edge of machine learning,
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-center">
              <div className="p-4 bg-white/5 rounded-lg">
                <h4 className="text-3xl font-bold text-techpurple mb-1">10+</h4>
                <p className="text-white/70 text-sm">AI Experts</p>
              </div>
              {/* <div className="p-4 bg-white/5 rounded-lg">
                <h4 className="text-3xl font-bold text-elecblue mb-1">2+</h4>
                <p className="text-white/70 text-sm">Countries</p>
              </div> */}
              <div className="p-4 bg-white/5 rounded-lg">
                <h4 className="text-3xl font-bold text-neon-green mb-1">10+</h4>
